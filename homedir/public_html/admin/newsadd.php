...
news_add.ShowHighlightText = "Show highlight"; 
news_add.HideHighlightText = "Hide highlight";
...
<div align="center" class="msm_h1">Add to TABLE: News</div>
...
<input type="file" name="x_photo" id="x_photo" size="30"<?php echo $news->photo->EditAttributes() ?>>
</div>
...
<p>
<input type="button" name="btnAction" id="btnAction" value="    Add    " onclick="ew_SubmitForm(news_add, this.form);">
</form>
<script type="text/javascript">
<!--
...
class cnews_add {
	...
	function LoadDefaultValues() {
		global $news;
		$news->photo->CurrentValue = NULL; // Clear file related field
	}
