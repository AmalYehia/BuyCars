...
// Define page object
$manfactuerer_logo_blobview = new cmanfactuerer_logo_blobview();
$Page =& $manfactuerer_logo_blobview;

// Page init processing
$manfactuerer_logo_blobview->Page_Init();

// Page main processing
$manfactuerer_logo_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cmanfactuerer_logo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'manfactuerer_logo_blobview';
	...
	//  - open connection
	//
	function cmanfactuerer_logo_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('manfactuerer', 'x_logo');
