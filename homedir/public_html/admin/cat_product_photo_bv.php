...
// Define page object
$cat_product_photo_blobview = new ccat_product_photo_blobview();
$Page =& $cat_product_photo_blobview;

// Page init processing
$cat_product_photo_blobview->Page_Init();

// Page main processing
$cat_product_photo_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccat_product_photo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'cat_product_photo_blobview';
	...
	//  - open connection
	//
	function ccat_product_photo_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('cat_product', 'x_photo');
