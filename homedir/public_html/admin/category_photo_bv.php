...
// Define page object
$category_photo_blobview = new ccategory_photo_blobview();
$Page =& $category_photo_blobview;

// Page init processing
$category_photo_blobview->Page_Init();

// Page main processing
$category_photo_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccategory_photo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'category_photo_blobview';
	...
	//  - open connection
	//
	function ccategory_photo_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('category', 'x_photo');
