...
// Define page object
$news_photo_blobview = new cnews_photo_blobview();
$Page =& $news_photo_blobview;

// Page init processing
$news_photo_blobview->Page_Init();

// Page main processing
$news_photo_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cnews_photo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'news_photo_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('news', 'x_photo');
