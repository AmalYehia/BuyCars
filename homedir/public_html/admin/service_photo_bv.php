...
// Define page object
$service_photo_blobview = new cservice_photo_blobview();
$Page =& $service_photo_blobview;

// Page init processing
$service_photo_blobview->Page_Init();

// Page main processing
$service_photo_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cservice_photo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'service_photo_blobview';
	...
	//  - open connection
	//
	function cservice_photo_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('service', 'x_photo');
